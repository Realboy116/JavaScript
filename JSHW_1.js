...
console.log('item_6 == '+item_6, 'item_6_type == '+typeof item_6_type); // 21. Вывести в консоль тип данных item_6 в виде ——  “item_6 == ”  item_6,  “item_6_type == ”  item_6_type —— 

let item_7 = String(item_6);//22. Создать переменную item_7 и в ней преобразовать item_6 в String.
console.log(typeof item_7); // Проверка 22 пункта
...
console.log(typeof item_7_type); // Проверка 24 пункта
console.log('item_7 == '+item_7, 'item_7_type == '+typeof item_7_type); // 25. Вывести в консоль тип данных item_7 в виде ——  “item_7 == ”  item_7,  “item_7_type == ”  item_7_type —— 

let age_1 = 59; // 26. Создать переменную “age_1” и присвоить ей значение 10
